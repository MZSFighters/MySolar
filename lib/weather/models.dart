...
class WeatherModel{
  ...
  factory WeatherModel.fromJson(Map<String, dynamic> data){
    ...
    return WeatherModel(currentWeather: currentWeather, hourlyWeather: hourlyWeather);
  }
}
...
class CurentWeather{
  ...
  CurentWeather({required this.temperature, required this.weathercode, required this.winddirection, required this.windspeed, required this.isDay});
  ...
  factory CurentWeather.fromJson(Map<String, dynamic> data){
    ...
    return CurentWeather(temperature: temperature, weathercode: weathercode, winddirection: winddirection, windspeed: windspeed, isDay: isDay);
