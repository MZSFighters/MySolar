...
Future<List<double>> calculateHourlyConsumption() async {
  ...
  DeviceConsumption deviceConsumption = DeviceConsumption(userId: userId ,firestore: firestore);

  // Get the hourly consumption data from devices
  List<double> deviceHourlyConsumption = await deviceConsumption.calculateHourlyConsumption();
...
Future<List<List<String>>> calculateDevicesOnEachHour() async {
  ...
  List<List<String>> devicesOnEachHour = await deviceConsumption.devicesOnEachHour();
