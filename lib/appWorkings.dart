...
class _AppWorkingsState extends State<AppWorkings> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: [
          _buildExpansionTile("The Prediction Graph Algorithm",
              Icons.show_chart, "assets/your_image1.png"),
          _buildExpansionTile("App Assumptions and Limtitations",
  ...
  Widget _buildExpansionTile(
      String title, IconData? iconData, String imagePath) {
            ...
            child: RichText(
              text: TextSpan(
                ...
                children: <TextSpan>[
                  ...
                  TextSpan(text: ' × (1 - '),
                  TextSpan(
                      text: 'cloud coverage/100',
                      style: TextStyle(fontStyle: FontStyle.italic)),
                  TextSpan(text: ') × ('),
                  TextSpan(
                      text: 'solarIrradiance/standardIrradiance',
                      style: TextStyle(fontStyle: FontStyle.italic)),
                  TextSpan(text: ')'),
                ],
              ),
